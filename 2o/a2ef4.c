...
void LinkedDelete(ListPointer *List, ListPointer PredPtr,int *pragma);
...
main(){
    ...
    while(!EmptyList(List1)){
        ...
        LinkedDelete(&List1,PredPtr=0,&stoixeio);
        
        LinkedInsert(&List2,stoixeio,PredPtr=0);
