...
//getters
	...
	/*
	 * αυτη η μεθοδος παιρνει σαν παραμετρο εναν user (u) και τον προσθετει στο γκρουπ
	 * αφου ,πρωτα ελεγξει αμα ειναι φιλος με καποιον απο τα υπαρχοντα μελη του γκρουπ ( η
	 * προηγουμενη συνθηκη δεν ισχυει για το πρωτο μελος του γκρουπ) και εκτυπωνει
	 * την επιτυχη ή μη εισαγωγη του στο γκρουπ.
	 * 
	 */
   ...
   {    boolean  g=false;
	 ...
	 //αυτη η μεθοδος εκτυπωνει τα μελη του γκρουπ χωρις να παιρνει καμια παραμετρο
