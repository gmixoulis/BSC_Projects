...
public class User {
	...
	/*
	 * Μέθοδο η οποία δέχεται ως παράμετρο έναν άλλο χρήστη και επιστρέφει true
	 * ή false ανάλογα με το αν είναι φίλοι ή όχι.
	 */
	...
	/*
	 * Μέθοδο η οποία προσθέτει στην λίστα των φίλων έναν άλλο χρήστη. Αυτό
	 * γίνεται αφού προηγηθεί έλεγχος για το αν πρόκειται για το ίδιο πρόσωπο ή
	 * για χρήστη που είναι ήδη φίλος παρανετρος ειναι ο user
	 */
	...
	/*
	 * ειναι μια μεθοδος που εκτυπωνει τους φιλους ενος χρηστη δεχεται σαν
	 * παραμετρο εναν χρηστη us.
	 */
	...
	/*
	 * αυτη η μεθοδος δεχεται σαν παραμετρο(g) ενα γκροπ ( το ανοιχτο) και
	 * προσθετει τον χρηστη σε αυτο το γκρουπ
	 */
	...
	/*
	 * αυτη η μεθοδος δεχεται σαν παραμετρο(g) ενα γκροπ ( το κλειστο) και
	 * προσθετει τον χρηστη σε αυτο το γκρουπ
	 */
	...
	/*
	 * αυτη η μεθοδος παιρνει εναν αλλον user σαν παραμετρο και δινει πισω μια
	 * λιστα με τους κοινους φιλους αυτων των 2
	 */
	 ...
	 * μια λιστα με τους κοινους φιλους αυτων των 2 (με την βοηθεια της
	 * HasFriends) , παραμετρος το us
	 */
	 ...
	 * συμπεριλαμβανομένων και των δικών του posts, ταξινομημένα με χρονολογική
	 * σειρά
	 * 
	 */
